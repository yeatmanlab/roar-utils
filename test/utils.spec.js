    ...
    [
        {
            ...
            preload: {
                group1: {
                    ...
                    shared: [
                        "image_asset2.png",
                        "shared_audio_asset1.mp3",
                        "shared_video_asset1.mp4",
                    ],
                },
                group2: {
                    languageSpecific: {
                        ...
                        shared: [
                            "nestedLang_shared_image2.png",
                            "nestedLang_shared_video2.mp4",
                        ],
                    },
                    shared: {
                        device: [
                            "nestedShared_image_asset2.png",
                            "audio_asset3.mp3",
                            "video_asset2.mp4",
                        ],
                    },
...
test("Creates the correct preload trials from all possible inputs", () => {
    for (const struc of structures) {
        ...
        if (struc[0].preload) {
            ...
            expect(preloadTrials.default.images).toContain(
                struc[1].imageAsset1
            );
            expect(preloadTrials.default.images).toContain(
                struc[1].imageAsset2
...
const testThresholdExceededCallback = jest.fn();

describe("ResponseTimeTracker", () => {
    let responseTimeTracker;

    beforeEach(() => {
        responseTimeTracker = new ResponseTimeTracker({
            minThreshold: 400,
            maxThreshold: 9000,
            thresholdExceededCallback: testThresholdExceededCallback,
