...
import {
  camelize, camelizeFiles, getAgeData, getGrade,
} from '../src/utils';
...
test('Correctly tracks response time', () => {
  // TODO: Write these tests.
  // Test that adding a response adds it to the response time array
  // Test that exceeding the max threshold calls the callback
  // Test that exceeding the min threshold calls the callback
  // This could be done with a callback that sets a boolean in the outer scope
  // to true if the threshold is exceeded
});
